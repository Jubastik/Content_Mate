...
class Ui_Change_Preset(object):
    def setupUi(self, Form):
        ...
        self.verticalLayout.addWidget(self.presets)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Изменить пресет"))
        ...
        self.label.setText(_translate("Form", "Выберите присет:"))
        self.save_btn.setText(_translate("Form", "Сохранить изменения пресета"))
